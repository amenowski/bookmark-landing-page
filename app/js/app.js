...
const btns = [...document.querySelectorAll(`.features__tabbed-btn`)];
...
btnContainer.addEventListener(`click`, (e) => {
  ...
  featuresContent.forEach((con) =>
    con.classList.remove(`features__content--active`)
  );

  btn.classList.add(`features__tabbed-btn--active`);

  document
    .querySelector(`.features__content--${btn.dataset.tab}`)
...
const toggleAccordion = (panelToActivate) => {
  ...
  const activePanel = panelToActivate.querySelector(
  ...
  if (activeIsPanelOpened === `true`) {
    panelToActivate
      .querySelector(`.accordion__panel-icon`)
      .setAttribute(`aria-expanded`, false);

    panelToActivate
      .querySelector(`.accordion__panel-content`)
      .setAttribute(`aria-hidden`, true);

    panelToActivate
      .querySelector(`.accordion__panel-icon`)
      .classList.add(`accordion__panel-icon--deactive`);
    panelToActivate
      .querySelector(`.accordion__panel-icon`)
      .classList.remove(`accordion__panel-icon--active`);
  }
  ...
  if (activeIsPanelOpened === `false`) {
    ...
    panelToActivate
      .querySelector(`.accordion__panel-icon`)
      .classList.remove(`accordion__panel-icon--deactive`);
    panelToActivate
      .querySelector(`.accordion__panel-icon`)
      .classList.add(`accordion__panel-icon--active`);
  }
};
